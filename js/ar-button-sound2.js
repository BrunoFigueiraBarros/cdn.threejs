export const compat = {
  ...
  const setupHref = (props) => {
    ...
    if (compat.IS_AR_QUICKLOOK_CANDIDATE) {
      ...
      href = `intent://arvr.google.com/scene-viewer/1.0?file=${src}&mode=ar_only&disable_occlusion=true&sound=https://cdn.glitch.global/65251a32-7c37-4c62-b2b8-a74d4d34ffab/RD3.mpeg?v=1692727195144`;
      if (title) {
